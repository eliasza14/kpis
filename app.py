...
def ad_button1(id,kpdf,js_code):
    ...
    with st.container():
        ...
        html(
        f"""<body style="display: flex;flex-wrap: nowrap;align-content: center;justify-content: center;">
        <div className="Frame10" style={{width: 330, height: 201, paddingBottom: 24, paddingLeft: 24, background: 'linear-gradient(138deg, rgba(198.55, 215.22, 244.37, 0.56) 0%, rgba(96, 239, 255, 0.55) 100%)', borderRadius: 15, justifyContent: 'flex-start', alignItems: 'flex-end', gap: 32, display: 'inline-flex'}}>
        <div style={{color: '#111416', fontSize: 160, fontFamily: 'Sofia Sans', fontWeight: '700', lineHeight: 16.93, wordWrap: 'break-word'}}>9</div>
        <div className="Frame11" style={{paddingTop: 24, paddingRight: 24, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-end', gap: 56, display: 'inline-flex'}}>
        <div style={{width: 56, height: 56, position: 'relative'}}>
            <div className="Ellipse24" style={{width: 55.79, height: 55.79, left: 0, top: 0, position: 'absolute', background: 'white', borderRadius: 9999}} />
            <div className="Vector" style={{width: 28, height: 23.24, left: 14, top: 15.75, position: 'absolute', background: 'linear-gradient(138deg, #548CEE 0%, #15E7FF 100%)'}}></div>
        </div>
        <div className="Frame9" style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 16, display: 'flex'}}>
            <div style={{color: '#8E8D8D', fontSize: 12, fontFamily: 'Ubuntu', fontWeight: '300', lineHeight: 24, wordWrap: 'break-word'}}>Σύνολο Εργαζομένων</div>
            <div style={{color: '#6E7279', fontSize: 24, fontFamily: 'Ubuntu', fontWeight: '300', lineHeight: 24, wordWrap: 'break-word'}}>Γεν. Πληθυσμού</div>
        </div>
        </div>
        </div>
