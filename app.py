...
<stop offset="1" stop-color="#15E7FF"/>
                            ...
                            <div>
                                <div class="number" style="text-align:center; font-size: 24px; font-family:  'Source Sans Pro',sans-serif; font-weight: 300; line-height: 24px; word-wrap: break-word">{str(val4)}</div>
                            </div>
                        </div>
	                </div>
                <script type="text/javascript">
