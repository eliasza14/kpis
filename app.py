...
def ad_button1(id,kpdf,js_code):
    ...
    with st.container():
        ...
        html(
                ...
                <div style="padding:10px;  width:300px; border-radius:5px; background: rgb(218,255,78); background: linear-gradient(45deg, rgba(218,255,78,1) 0%, rgba(255,37,37,1) 100%);">
