            ...
            f"""
                <body>
                    <div style="display:flex;">
                        <div style="background: lightcoral;display: flex;align-items: center;flex-direction: column;flex-wrap: nowrap;border: 1px solid transparent;border-radius: 16px;padding: 5px;">
                            <div>icon</div>
                            <div id="counter" style="text-align: left; color:white;    font-family: 'Source Sans Pro',sans-serif;font-weight: bold; font-size: 60px;   "></div>
                            <div>hello there</div>
                        </div>
