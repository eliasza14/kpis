...
def ad_button3(id,kpdf,js_code):
    ...
    with st.container():
        ...
        with col1:
            ...
            # st.write('Δ14-'+text)
            st.markdown("<h3 style='text-align: center; color: grey;'>Ωρες απασχολησης εργαζομένων ΛΥΨΥ</h3><h3 style='text-align: center; color: grey;'>(Μεσος Όρος)</h3>", unsafe_allow_html=True)
        ...
        with col2:
            ...
            st.markdown("<h3 style='text-align: center; color: grey;'>Ωρες απασχολησης εργαζομένων ΕΚΟ</h3><h3 style='text-align: center; color: grey;'>(Μεσος Όρος)</h3>", unsafe_allow_html=True)
