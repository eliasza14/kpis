...
def ad_button1(id,kpdf,js_code):
    ...
    with st.container():
        ...
        html(
                ...
                <div style=" padding:5px; background: rgb(34,193,195);background: linear-gradient(45deg, rgba(34,193,195,1) 0%, rgba(253,187,45,1) 100%); width:200px; border-radius:5px;">
