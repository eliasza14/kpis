...
def ad_button2(id,kpdf,js_code):
    ...
    with st.container():
        ...
        with col1:
            ...
            st.markdown("<p style='text-align: center; color: black; font-size:24px; font-family:Roboto;'>Εργαζόμενοι Γεν. Πληθ.</p><p  style='text-align: center; color: black; font-size:24px; font-family:Roboto;'>(% επί του Συνόλου)</p>", unsafe_allow_html=True)
