...
def main():
   ...
   #Radio button
    ...
    with st.expander("Options"):
        st.markdown("## Ανθρώπινο Δυναμικό")
        option1 = st.radio(
            "Επιλέξτε επιλογή",
            [
                "Εργαζόμενοι",
        ...
        st.markdown("## Επιχειρηματικότητα")
        option2 = st.radio(
            "Επιλέξτε επιλογή",
            [
                "Σύνολο κύκλου εργασιών ανά τομέα & κατανομή ανά δραστηριότητα ανά έτος",
                "% μεταβολής κύκλου εργασιών ανά δραστηριότητα ανά έτος",
                "Κατανομή πλήθους ΚοιΣΠΕ βάσει προσίμου καθαρών ανά έτος"
            ]
        )

    st.write("Selected options:")
    st.write("Ανθρώπινο Δυναμικό:", option1)
    st.write("Επιχειρηματικότητα:", option2)
